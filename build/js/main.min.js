...
/* harmony import */ var _modules_init_accordion_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-accordion.js */ "./js/modules/init-accordion.js");
/* harmony import */ var _modules_animation_cards_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/animation-cards.js */ "./js/modules/animation-cards.js");
/* harmony import */ var _modules_logo_animation_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/logo-animation.js */ "./js/modules/logo-animation.js");
/* harmony import */ var _modules_init_scroll_separator_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-scroll-separator.js */ "./js/modules/init-scroll-separator.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    var burger = new _modules_burger__WEBPACK_IMPORTED_MODULE_5__["Burger"]();
    burger.init();
    Object(_modules_init_accordion_js__WEBPACK_IMPORTED_MODULE_6__["initAccordions"])();
    Object(_modules_animation_cards_js__WEBPACK_IMPORTED_MODULE_7__["animationCards"])();
    Object(_modules_logo_animation_js__WEBPACK_IMPORTED_MODULE_8__["logoAnimation"])();
    Object(_modules_init_scroll_separator_js__WEBPACK_IMPORTED_MODULE_9__["initScrollSeparator"])();
  });
});
...
/*!***************************************!*\
  !*** ./js/modules/animation-cards.js ***!
  \***************************************/
/*! exports provided: animationCards */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animationCards", function() { return animationCards; });
var animationCards = function animationCards() {
  var cardsContainer = document.querySelector('.resources__cards');
  if (!cardsContainer) {
    return;
  }
  var cardsList = Array.from(cardsContainer.querySelectorAll('.card'));
  cardsContainer.setAttribute('data-active', cardsList.length - 1);
  var clickCardHandler = function clickCardHandler(evt) {
    evt.preventDefault();
    var number = evt.target.closest('.card').getAttribute('data-number');
...
/*!**************************************!*\
  !*** ./js/modules/logo-animation.js ***!
  \**************************************/
/*! exports provided: logoAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "logoAnimation", function() { return logoAnimation; });
/* harmony import */ var _vendor_scroll_lock_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/scroll-lock.min */ "./js/vendor/scroll-lock.min.js");
/* harmony import */ var _vendor_scroll_lock_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_scroll_lock_min__WEBPACK_IMPORTED_MODULE_0__);
...
var logoAnimation = function logoAnimation() {
  ...
  var endAnimation = function endAnimation() {
    _vendor_scroll_lock_min__WEBPACK_IMPORTED_MODULE_0___default.a.enablePageScroll();
    pageLogo.classList.add('is-hidden');
    pageLogo.classList.remove('play');
  };
  _vendor_scroll_lock_min__WEBPACK_IMPORTED_MODULE_0___default.a.disablePageScroll();
